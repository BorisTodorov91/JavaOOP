...
public class ReflectionUtils {
    ...
    public static <T extends Member> Stream<T> filterMembersByName(Method[] members, String filter) {
        return (Stream<T>) filterMembers(members, m -> m.getName().contains(filter));
    }
